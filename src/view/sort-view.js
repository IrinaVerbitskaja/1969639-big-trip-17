...
import {SortType} from '../util/filter-type.js';

const createSortTemlate = (currentSortType) => (
...
export default class NewSortView extends AbstractView {
  ...
  get template() {
    return createSortTemlate(this.#currentSortType);
  }
  ...
  #sortTypeChangeHandler = (evt) => {
    if (evt.target.tagName !== 'INPUT' || evt.target.disabled === true) {
      return;
    }
